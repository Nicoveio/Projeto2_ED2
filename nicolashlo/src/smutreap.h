...
/*
 * Define o valor máximo que pode ser atribuído como prioridade
 * para os nós da árvore t. Esse valor será usado para gerar prioridades
 * aleatórias na faixa [0, prioridade].
 * Deve ser chamado antes das inserções para garantir que as prioridades
 * estejam dentro do intervalo desejado.
 */
